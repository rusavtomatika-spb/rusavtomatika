...
include_once $core_admin_path . 'products_all/template/header.php';
...
<form action="/admin/products_all/add_element.php" method="get">
...
<? include $core_admin_path . 'products_all/template/footer.php'; ?>