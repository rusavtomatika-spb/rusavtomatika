...
if (!empty($result)) {
    ...
    echo "<th>Старьё</th>";
    echo "<th>Цена</th>";
    echo "<th>Скрыть цену</th>";
    echo "<th>Рекомендовано</th>";
    echo "<th>На складе</th>";
    echo "<th>На складе СПБ</th>";
    echo "<th>Показ На складе</th>";
    echo "<th>Показ в каталоге</th>";
    echo "<th>";
    echo "<th class='td_center'>Действия</th>";
    echo "</tr>";
    $counter = 0;
    if (is_array($result)) {
        connectToFTP();
...
//            $imagesHtml = getImagesHtml($row);
            ...
            echo "</td>";
            echo "<td class='code'>";
            echo $row['show_on_stock'];
            echo "</td>";
            echo "<td class='code'>";
            echo $row['show_in_cat'];
            echo "</td>";
