...
<div id="cc1">
    ...
    <table><tr>
            ...
            <td width="50"> </td> <td class="tds" >Переменная 1</td><td id="val1">0 </td> <td class="tds"> Переменная 2  </td><td> <div id="val2" >0</div></td>
    ...
    <div>Данные от панели оператора в формате JSON</div>
    <div id="mes">  </div>

    Скачать проект для операторской панели можно <a href="mqtt_test.emtp">здесь</a><br>
    Проект сделан для панели MT8090XE, если вы хотите его загрузить в другую панель, нужно будет<br>
    в проекте изменить модель.
