...
<div class="catalog_element_default">
    ...
    <? else: ?>
        <h1>Программируемый модуль расширения ПЛК: Haiwell <?= $arResult["element"]["name"] ?>, со склада</h1>
    <? endif; ?>
                    ...
                    <div id="tabs-1">
                        ...
                        <div>
                            <table class="table_style2">
                                ...
                                <td>Каналы</td>
                                <td><?= $properties["specification"]["value"] ?></td>
                                </tr>
                                <tr><td><?= $properties["conversion"]["name"] ?></td>
                                    <td><?= $properties["conversion"]["value"] ?></td>
                                </tr>
                                <tr><td><?= $properties["com"]["name"] ?></td>
                                    <td><?= $properties["com"]["value"] ?></td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div id="tabs-3"><h2>Схемы <?= $arResult["element"]["name"] ?></h2>
                        <div class="catalog_element_default_diagrams">
                            ...
                            <? if ($properties["product-specification"]["value"] != "") { ?>
                                <div><?= $properties["product-specification"]["value"] ?></div>
                            <? } ?>
