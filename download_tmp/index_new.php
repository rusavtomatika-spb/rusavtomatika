...
$soft_result = $_SERVER[ 'DOCUMENT_ROOT' ] . '/documents__/soft_result.txt';
$um_arc = $_SERVER[ 'DOCUMENT_ROOT' ] . '/documents__/um_arc.txt';
...
function filter_arr( $arr_type, $array, $key, $value, $exclude1 = 'qqqqqqqq', $exclude2 = 'qqqqqqqq', $exclude3 = 'qqqqqqqq', $exclude4 = 'qqqqqqqq', $exclude5 = 'qqqqqqqq' ) {
  if ( is_array( $array ) ) {
    foreach ( $array as $element ) {
      ...
      if ( strpos( $element[ $key ], $value ) !== false ) {
        ...
        if ( $element[ 'mod_data' ] != 'N/A' ) {
          $mod_data = '[' . $element[ 'mod_data' ] . ']';
        } else $mod_data = '';
		if (strpos( $element[ 'put' ], 'http' ) !== false) {
			$our_url = $element[ 'url' ];
		} else {
			$our_url = $arr_type . $element[ 'put' ] . '/' . $element[ 'fname' ];
		}
        if (( strpos( $element[ 'put' ], $exclude1 ) !== false )OR( strpos( $element[ 'put' ], $exclude2 ) !== false )OR( strpos( $element[ 'put' ], $exclude3 ) !== false )OR( strpos( $element[ 'put' ], $exclude4 ) !== false )OR( strpos( $element[ 'put' ], $exclude5 ) !== false )) {
          continue;
        }
        echo '<p><a class="download_' . strtolower( $info[ 'extension' ] ) . '" href="' . $our_url . '">' . $element[ 'title' ] . '</a> <span class="small_gray_text">' . $mod_data . $fsize . '</span></p>';
...
function arr_out( $array ) {
  if ( is_array( $array ) ) {
    foreach ( $array as $element ) {
      ...
      echo '<p><a class="download_' . $info[ 'extension' ] . '" href="/documents_ra/' . $element[ 'put' ] . '/' . $element[ 'fname' ] . '">' . $element[ 'title' ] . '</a> <span class="small_gray_text">[' . $element[ 'mod_data' ] . ']' . $fsize . '</span></p>';
      //				echo $element[ 'title' ].'<br>';
      //                return $element;
    }
  }
...
$arc = [
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/60801.pdf",
    "fname" => "60801",
    "version" => "6.08.01"
  ],
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/60702.pdf",
    "fname" => "60702",
    "version" => "6.07.02"
  ],
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/60701.pdf",
    "fname" => "60701",
    "version" => "6.07.01"
  ],
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/60602.pdf",
    "fname" => "60602",
    "version" => "6.06.02"
  ],
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/60401.pdf",
    "fname" => "60401",
    "version" => "6.04.01"
  ],
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/60302.pdf",
    "fname" => "60302",
    "version" => "6.03.02"
  ],
  [
    "url" => "/documents_ra/EBPro/UserManual/eng/arc/50701.pdf",
    "fname" => "50701",
    "version" => "5.07.01"
  ]
];
  ...
  <div class="container page_downloads">
    <div class="columns  is-multiline">
      <div class="column is-12">
        <div class="columns is-multiline">
          <div class="column is-12">
            <h1>Скачать EasyBuilder Pro, EasyBuilder 8000, EBPro, EB8000, SKWorkshop, драйвера Aplex, драйвера IFC, документация, гайд, руководство, инструкция, мануал</h1>
          </div>
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">EasyBuilder Pro</span> &nbsp;&nbsp;&nbsp; серии <a href="/catalog/operator_panels/?&series=MT8000iE">MT8000iE</a>, <a href="/catalog/operator_panels/?&series=eMT3000">eMT3000</a>, <a href="/catalog/operator_panels/?&series=MT8000XE">MT8000XE</a>, <a href="/weintek/mTV-100/">mTV</a>, <a href="/catalog/operator_panels/?&series=cMT">cMT</a>, <a href="/catalog/operator_panels/?&series=cMT-X">cMT X</a> </div>
          </div>
          ...
          <div class="column is-5">
            <div class="block_padding">
              <?
              filter_arr( '/soft/',$progs, 'section', 'ebpro' );
              ?>
              <p><a class="download_pdf" href="/soft/EBPro/release_notes/EBProV60901_ReleaseNotes_en.pdf" target="_blank">Примечания к выпуску 6.09.01.322 (Eng)</a> <span class="small_gray_text">[13-11-2023]</span></p>
				<?
              filter_arr('/documents_ra/', $items, 'title', 'All chapters' );
				files_out( $arc, '/documents_ra/EBPro/UserManual/eng/arc/' );
              ?>
              <p><a class="download_linkext_online" href="/weintek-easybuilderpro-user-manual-en/">On-line руководство пользователя<br>
                Weintek EasyBuilder Pro (Eng) </a> <span style="margin-left:3px;" class="small_gray_text">[13-11-2023]</span></p>
        ...
        <div class="columns  is-multiline">
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">EasyBuilder 8000</span> &nbsp;&nbsp;&nbsp; серии MT6000i, MT8000i </div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-5">
            <div class="block_padding">
              <? filter_arr('/documents_ra/', $items, 'title', 'Device (PLC) Connection Guide' );?>
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-5">
            <div class="block_padding">
              <?
              filter_arr( '/soft/',$progs, 'section', 'ea20' );
              filter_arr( '/documents_ra/',$items, 'section', 'ea20' );
              ?>
        ...
        <div class="columns  is-multiline">
          <div class="column is-12 background-gray">
            <div class="block_padding" id="cMTViewer"> <span class="page_downloads_title3">cMT Viewer</span> &nbsp;&nbsp;&nbsp; серии: <a href="/catalog/operator_panels/?&series=cMT">cMT</a>, <a href="/catalog/operator_panels/?&series=cMT-X">cMT-X</a></div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
          ...
          <div class="column is-5">
            <div class="block_padding">
              <?
              filter_arr('/soft/', $progs, 'put', 'cMTViewer' );
              filter_arr( '/soft/',$progs, 'section', 'cmt' );
              filter_arr( '/documents_ra/',$items, 'section', 'cmt', 'Datasheet', 'Installation', 'Certificate' );
              ?>
        ...
        <div class="columns  is-multiline">
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">EasyLauncher</span> &nbsp;&nbsp;&nbsp; модель <a href="/weintek/cMT-iPC15/">cMT-iPC15</a></div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
          ...
          <div class="column is-5">
            <div class="block_padding">
              <?
              filter_arr( '/soft/',$progs, 'put', 'EasyLauncher' );
              filter_arr( '/documents_ra/',$items, 'section', 'easylauncher' );
              ?>
            </div>
          </div>
        </div>
        <div class="columns  is-multiline"><a name="EasyRemote"></a>
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">EasyRemote I/O</span> для <a href="/plc/weintek/iR-ETN/">Weintek iR-ETN</a></div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
          ...
          <div class="column is-5">
            <div class="block_padding">
				              <?
              filter_arr( '/soft/',$progs, 'put', 'EasyRemote' );
//				echo '<hr>';
              filter_arr( '/documents_ra/',$items, 'title', 'EasyRemoteIO');
              filter_arr('/soft/', $progs, 'title', 'cMT+CODESYS');
              ?>
            </div>
          </div>
        </div>
        <div class="columns  is-multiline">
          ...
          <div class="column is-5">
            <div class="block_padding">
				              <?
              filter_arr( '/soft/',$progs, 'title', 'CODESYS IDE');
			//	echo '<hr>';
              ?>
            </div>
          </div>
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-5">
            <div class="block_padding">
				              <?
              filter_arr( '/documents_ra/',$items, 'title', 'Quick Start Guide');
              ?>
            </div>
          </div>
        </div>
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">Программное обеспечение для vpn-роутеров eWON</span> </div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">Приложение HaiwellHappy </span> </div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">YottaEditor</span> </div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
              <p> YottaEditor предназначен для работы сo всеми контроллерами <a href="">Yottacontrol</a> серий: A-51, A-52. </p>
              <p> Поддерживаемые ОС: Windows 98 / ME / 2000 / XP / Vista / 7 / 8. </p>
            </div>
          </div>
          <div class="column is-5">
            <div class="block_padding">
        ...
        <div class="columns  is-multiline">
          <div class="column is-12 background-gray">
            <div class="block_padding"> <span class="page_downloads_title3">YottaUtility</span> </div>
          </div>
          <div class="column is-7">
            <div class="block_padding">
              <p> YottaUtility предназначен для работы сo всем оборудованием <a href="">Yottacontrol</a>, контроллерами серий: A-51, A-52 и модулями серий A-10, A-21 и A-18.</p>
              <p> Поддерживаемые ОС: Windows 98 / ME / 2000 / XP / Vista / 7 / 8. </p>
            </div>
          </div>
          <div class="column is-5">
