...
function filter_arr( $array, $key, $value, $exclude1 = 'qqqqqqqq', $exclude2 = 'qqqqqqqq', $exclude3 = 'qqqqqqqq', $exclude4 = 'qqqqqqqq', $exclude5 = 'qqqqqqqq' ) {
  if ( is_array( $array ) ) {
    foreach ( $array as $element ) {
      ...
      if ( strpos( $element[ $key ], $value ) !== false ) {
        ...
        echo '<p><a class="download_' . strtolower( $info[ 'extension' ] ) . '" href="/soft/' . $element[ 'put' ] . '/' . $element[ 'fname' ] . '">' . $element[ 'title' ] . '</a> <span class="small_gray_text">' . $mod_data . $fsize . '</span></p>';
...
function arr_out( $array ) {
  if ( is_array( $array ) ) {
    foreach ( $array as $element ) {
      ...
      echo '<p><a class="download_' . $info[ 'extension' ] . '" href="/upload_files/documents/weintek/' . $element[ 'put' ] . '/' . $element[ 'fname' ] . '">' . $element[ 'title' ] . '</a> <span class="small_gray_text">[' . date("d.m.Y",$element[ 'mod_data' ]) . ']' . $fsize . '</span></p>';
      //				echo $element[ 'title' ].'<br>';
      //                return $element;
    }
  }
        ...
        <div class="columns  is-multiline">
          ...
          <div class="column is-5">
            <div class="block_padding">
              ...
              ?>
              <p><a class="download_pdf" href="/soft/EBPro/release_notes/EBPro_ReleaseNotes_en.pdf" target="_blank">Примечания к выпуску версии <? echo file_get_contents('https://www.rusavtomatika.com/upload_files/soft/EBPro/Installer/version.txt'); ?> (Eng)</a> <span class="small_gray_text">[<? echo date("d.m.Y",file_get_contents('https://www.rusavtomatika.com/upload_files/soft/EBPro/Installer/date.txt')); ?>]</span></p>
              ...
              <p><a class="download_linkext_online" href="/weintek-easybuilderpro-user-manual-en/">On-line руководство пользователя<br>
                Weintek EasyBuilder Pro (Eng) </a> <span style="margin-left:3px;" class="small_gray_text">[<? echo date("m.d.Y",file_get_contents('https://www.rusavtomatika.com/upload_files/manuals/weintek/UserManual_separate_chapter/update_date.txt')); ?>]</span></p> <?
