<li class="glide__slide">
    ...
    <a class="card" href="<?= $item["url_page_detail2"] ?>">
        ...
        <div class="card-image">
            ...
            <div class="model_image" itemscope="" itemtype="https://schema.org/ImageObject" style="            background-image: url('<?= $item["img"] ?>');            background-size: cover;            background-position: center;            background-repeat: no-repeat;width:260px;height:180px;">
