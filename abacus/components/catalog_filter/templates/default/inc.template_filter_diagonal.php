        ...
        <div class="column is-12">
            <div class="filter_field_block__input_range_wrapper">
                <input class="filter_field_block__input_range"
                       v-model="filterSelectedRangeDiagonal_min" type="text" oninput="validateDecimal(this)" id="filter_diagonal_min">
                <input class="filter_field_block__input_range right"
                       v-model="filterSelectedRangeDiagonal_max" type="text" oninput="validateDecimal(this)" id="filter_diagonal_max">
