var app = new Vue({
  ...
  data: {
    ...
    filterSelectedHddSATA: false,
    filterSelectedHddmSATA: false,
    filterSelectedHddM2: false,
    filterSelectedHddPCIE: false,
    filterSelectedPlast: false,
    filterSelectedAlum: false,
    filterSelectedPlastAlum: false,
    filterSelectedOss: [],
    filterSelectedResolutions: [],
    filterSelectedProcessors: [],
    filterSelectedethernets_fix: [],
    ...
    section_list__set_management_show: false,
    ...
    filterSelectedRangerammax_min: null,
    filterSelectedRangerammax_max: null,
    filterSelectedRangerammax_min_start: 0,
    filterSelectedRangerammax_max_start: 0,

    filterSelectedRangeUSB_min: null,
    filterSelectedRangeUSB_max: null,
    filterSelectedRangeUSB_min_start: 0,
    filterSelectedRangeUSB_max_start: 0,
    ...
    filterSelectedmanagement: "0",
    filterSelectedSensorType: "",
    filterSelectedСase_material: "",
    filter_string: "",
    filter_selected_brands_string: "",
    url: {
      get_data: '/abacus/components/catalog_section/templates/default/ajax_catalog_section.php',
    },
    loading_status: false,
    result: "",
    html_filtered_products: $('.component_catalog_section__panel_of_products').html(),
  ...
  watch: {
    extra_h1: function (newVal) {
      ...
      let new_UPPER_SEO_TEXT = $('#component_seo_UPPER_SEO_TEXT').html();
      let new_LOWER_SEO_TEXT = $('#component_seo_LOWER_SEO_TEXT').html();
      if (newVal.length > 0) {
      ...
      $('.pretext').html(new_UPPER_SEO_TEXT);
      $('.posttext').html(new_LOWER_SEO_TEXT);
      if (new_UPPER_SEO_TEXT == 'no') {
      $('.pretext').html('');
      }
      if (new_LOWER_SEO_TEXT == 'no') {
      $('.posttext').html('');
      }
		//alert(new_UPPER_SEO_TEXT);
    },
    ...
    filterSelectedRangerammax_min: function (newVal) {
      if (this.filterSelectedRangerammax_min < this.filterSelectedRangerammax_min_start) {
        this.filterSelectedRangerammax_min = this.filterSelectedRangerammax_min_start;
      }
      $("#rammax-slider").slider("option", "values", [this.filterSelectedRangerammax_min, this.filterSelectedRangerammax_max]);
      //if(!this.init_in_process) this.filterChanged();
    },
    filterSelectedRangerammax_max: function () {
      if (this.filterSelectedRangerammax_max > this.filterSelectedRangerammax_max_start) {
        this.filterSelectedRangerammax_max = this.filterSelectedRangerammax_max_start;
      }
      $("#rammax-slider").slider("option", "values", [this.filterSelectedRangerammax_min, this.filterSelectedRangerammax_max]);
      //if(!this.init_in_process) this.filterChanged();
    },

    filterSelectedRangeUSB_min: function (newVal) {
      if (this.filterSelectedRangeUSB_min < this.filterSelectedRangeUSB_min_start) {
        this.filterSelectedRangeUSB_min = this.filterSelectedRangeUSB_min_start;
      }
      $("#USB-slider").slider("option", "values", [this.filterSelectedRangeUSB_min, this.filterSelectedRangeUSB_max]);
      //if(!this.init_in_process) this.filterChanged();
    },
    filterSelectedRangeUSB_max: function () {
      if (this.filterSelectedRangeUSB_max > this.filterSelectedRangeUSB_max_start) {
  ...
  methods: {
    clear_filter_item(filter_name, item) {
      ...
      switch (filter_name) {
        ...
        case 'filterSelectedWebView':
          ...
          this.filterChanged();
          break;
        case 'filterSelectedpoe':
          this.filterSelectedpoe = false;
          this.filterChanged();
          break;
        ...
        case 'filterSelectedCameraUSB':
          ...
          this.filterChanged();
          break;
        case 'filterSelectedHddSATA':
          this.filterSelectedHddSATA = false;
          this.filterChanged();
          break;
        case 'filterSelectedHddmSATA':
          this.filterSelectedHddmSATA = false;
          this.filterChanged();
          break;
        case 'filterSelectedHddM2':
          this.filterSelectedHddM2 = false;
          this.filterChanged();
          break;
        case 'filterSelectedHddPCIE':
          this.filterSelectedHddPCIE = false;
          this.filterChanged();
          break;
        case 'filterSelectedPlast':
          this.filterSelectedPlast = false;
          this.filterChanged();
          break;
        case 'filterSelectedAlum':
          this.filterSelectedAlum = false;
          this.filterChanged();
          break;
        case 'filterSelectedPlastAlum':
          this.filterSelectedPlastAlum = false;
          this.filterChanged();
          break;
        ...
        case 'filterSelectedProcessors':
          ...
          this.filterChanged();
          break;
        case 'filterSelectedethernets_fix':
          this.filterSelectedethernets_fix.splice(this.filterSelectedethernets_fix.indexOf(item), 1);
          this.filterChanged();
          break;
        ...
        case 'filterSelectedAvailablity':
          ...
          this.filterChanged();
          break;
        case 'filterSelectedmanagement':
          this.filterSelectedmanagement = "0";
          this.filterChanged();
          break;
        ...
        case 'filterSelectedRangerammax_min':
          this.filterSelectedRangerammax_min = this.filterSelectedRangerammax_min_start;
          this.filterChanged();
          break;
        case 'filterSelectedRangerammax_max':
          this.filterSelectedRangerammax_max = this.filterSelectedRangerammax_max_start;
          this.filterChanged();
          break;

        case 'filterSelectedRangeUSB_min':
          this.filterSelectedRangeUSB_min = this.filterSelectedRangeUSB_min_start;
          this.filterChanged();
          break;
        case 'filterSelectedRangeUSB_max':
          this.filterSelectedRangeUSB_max = this.filterSelectedRangeUSB_max_start;
          this.filterChanged();
          break;
        case 'filterSelectedRangeCOM_min':
          this.filterSelectedRangeCOM_min = this.filterSelectedRangeCOM_min_start;
          this.filterChanged();
          break;
        case 'filterSelectedRangeCOM_max':
          this.filterSelectedRangeCOM_max = this.filterSelectedRangeCOM_max_start;
          this.filterChanged();
          break;
        ...
        case 'all':
          ...
          this.filterSelectedethernets_fix = [];
          this.filterSelectedSeries = "";
    ...
    open_form_require_price(e) {
      ...
      $('.formmodel').val(e.target.getAttribute('data-rel-model'));
      setTimeout(function () {
        ...
        switch (box) {
          ...
          case 'cart':
            ...
            if (this.cart.indexOf(model) == -1) {
              $(button).addClass('active');
              $(button).html('<i class=\"fa-solid fa-check\" style=\"font-size:1.1rem;\"></i>&nbsp;&nbsp;<span>В ЗАКАЗЕ</span>');
              ...
              $(button).removeClass('active');
              $(button).html('<i class=\"fa-solid fa-cart-plus\" style=\"font-size:1.1rem;\"></i>&nbsp;&nbsp;<span>В ЗАКАЗ</span>');
              //this.do_flying_row($(button));
            }
    ...
    clicked_button_clear_filter_field_block(filter) {
      switch (filter) {
        case 'filterSelectedRangeEthernets':
          ...
          this.filterChanged();
          break;
        case 'filterSelectedRangerammax':
          this.filterSelectedRangerammax_min = this.filterSelectedRangerammax_min_start;
          this.filterSelectedRangerammax_max = this.filterSelectedRangerammax_max_start;
          this.filterChanged();
          break;
        case 'filterSelectedRangeUSB':
          this.filterSelectedRangeUSB_min = this.filterSelectedRangeUSB_min_start;
          this.filterSelectedRangeUSB_max = this.filterSelectedRangeUSB_max_start;
          this.filterChanged();
          break;
    ...
    change_management() {
      if (this.filterSelectedmanagement == "1") {
        this.filterSelectedmanagement = "0";
      } else this.filterSelectedmanagement = "1";
      this.filterChanged();
    },
    ...
    change_view_mode(mode) {
      ...
      this.setCookie('section_catalog_view_mode', mode, {
        'expires': date
      });
      this.filterChanged();
    },
    ...
    change_view_sort() {
      ...
      this.setCookie('section_catalog_view_sort_section', this.current_section, {
        'expires': date
      });
      this.setCookie('section_catalog_view_sort_' + this.current_section, this.product_sort, {
        'expires': date
      });
      this.filterChanged();
    },
    filterChanged(event) {
      ...
      if (this.filterSelectedRangerammax_min >= this.filterSelectedRangerammax_min_start && !(this.filterSelectedRangerammax_min == this.filterSelectedRangerammax_min_start && this.filterSelectedRangerammax_max == this.filterSelectedRangerammax_max_start)) {
        this.filter_string += '&rammax_range_min=' + this.filterSelectedRangerammax_min;
      }
      if (this.filterSelectedRangerammax_max >= 0
        && this.filterSelectedRangerammax_max >= this.filterSelectedRangerammax_min
        && this.filterSelectedRangerammax_max <= this.filterSelectedRangerammax_max_start
        && !(this.filterSelectedRangerammax_min == this.filterSelectedRangerammax_min_start && this.filterSelectedRangerammax_max == this.filterSelectedRangerammax_max_start)
      ) {
        this.filter_string += '&rammax_range_max=' + this.filterSelectedRangerammax_max;
      }

      if (this.filterSelectedRangeUSB_min >= this.filterSelectedRangeUSB_min_start && !(this.filterSelectedRangeUSB_min == this.filterSelectedRangeUSB_min_start && this.filterSelectedRangeUSB_max == this.filterSelectedRangeUSB_max_start)) {
        this.filter_string += '&USB_range_min=' + this.filterSelectedRangeUSB_min;
      }
      if (this.filterSelectedRangeUSB_max >= 0
        && this.filterSelectedRangeUSB_max >= this.filterSelectedRangeUSB_min
        && this.filterSelectedRangeUSB_max <= this.filterSelectedRangeUSB_max_start
        && !(this.filterSelectedRangeUSB_min == this.filterSelectedRangeUSB_min_start && this.filterSelectedRangeUSB_max == this.filterSelectedRangeUSB_max_start)
      ) {
        this.filter_string += '&USB_range_max=' + this.filterSelectedRangeUSB_max;
      }
      ...
      if (this.filterSelectedethernets_fix.length > 0) {
        let sorted_list = this.filterSelectedethernets_fix;
        sorted_list.sort();
        this.filter_string += '&ethernets_fix=';
        sorted_list.forEach(function (item, i) {
          current_context.filter_string = current_context.filter_string + item + ',';
        });
        this.filter_string = this.filter_string.replace(/,\s*$/, "");
      ...
      if (this.filterSelectedpoe) {
        this.filter_string += '&poe=yes';
      }
      ...
      if (this.filterSelectedHddSATA) {
        this.filter_string += '&HddSATA=yes';
      }
      if (this.filterSelectedHddmSATA) {
        this.filter_string += '&HddmSATA=yes';
      }
      if (this.filterSelectedHddM2) {
        this.filter_string += '&HddM2=yes';
      }
      if (this.filterSelectedHddPCIE) {
        this.filter_string += '&HddPCIE=yes';
      }
      if (this.filterSelectedPlast) {
        this.filter_string += '&plast=yes';
      }
      if (this.filterSelectedAlum) {
        this.filter_string += '&alum=yes';
      }
      if (this.filterSelectedPlastAlum) {
        this.filter_string += '&plastalum=yes';
      }
      ...
      if (this.filterSelectedmanagement != "0") {
        this.filter_string += '&management=' + this.filterSelectedmanagement;
      }
        ...
        this.extra_h1_arr.forEach(function (item, i, arr) {
          ...
          switch (item_splitted[0]) {
            ...
            case "ethernets_range_max":
              ...
              break;
            case "rammax_range_min":
              h1_chunk = ",max Размер ОЗУ от " + item_splitted[1] + "";
              break;
            case "rammax_range_max":
              h1_chunk = ",max Размер ОЗУ до " + item_splitted[1] + "";
              break;
            case "USB_range_min":
              h1_chunk = ",количество USB от " + item_splitted[1] + "";
              break;
            case "USB_range_max":
              h1_chunk = ",количество USB до " + item_splitted[1] + "";
              break;
            case "com_range_min":
              h1_chunk = ",количество COM от " + item_splitted[1] + "";
              break;
            case "com_range_max":
            ...
            case "HddPCIE":
              ...
              break;
            case "plast":
              h1_chunk = ",корпус из пластика";
              break;
            case "alum":
              h1_chunk = ",корпус из алюминия";
              break;
            case "plastalum":
              h1_chunk = ",корпус из пластика и металла";
              break;
            case "cmtviewer":
              h1_chunk = ",CMT Viewer";
              break;
            ...
            case "processors":
              ...
              break;
            case "ethernets_fix":
              h1_chunk = ",ethernet-портов: " + item_splitted[1] + "";
              break;
            case "series":
    ...
    send_ajax_query() {
      ...
      axios({
        ...
        if (response.data.length > 0) {
          ...
          this.html_filtered_products = $('.component_catalog_section__panel_of_products').html();
          this.init_after_ajax();
        }
      })
    ...
    init_after_ajax() {
      ...
      if ((cursection != 'screenless_operator_panels') || (cursection != 'operator_panels') || (curbrand != 'Weintek')) {
        $('#inc_weintek_info').addClass('is-hidden');
      }
      if ((cursection == 'screenless_operator_panels') || ((cursection == 'operator_panels') && (curbrand == 'Weintek'))) {
      ...
      setTimeout(() => {
        ...
        //
        //                        $('.pretext').html(component_seo_UPPER_SEO_TEXT);
        ...
        //                        $('.posttext').html(seo_LOWER_SEO_TEXT);
          ...
          if (action) {
            ...
            switch (box) {
              ...
              case 'cart':
                if (this.cart.indexOf(model) != -1) {
                  u.classList.add("active");
                  $(u).html("<i class=\"fa-solid fa-check\" style=\"font-size:20px;\"></i>&nbsp;&nbsp;<span style=\"top: -1px; position: relative;\">В ЗАКАЗЕ</span>");
                  //$(u).html("В ЗАКАЗЕ");
                }
                break;
              case 'compare':
                    ...
                    if (cart != "") {
                      ...
                      $('.series_products__button.cart').each(function () {
                        ...
                        if (context.cart.indexOf(model) === -1) {
                          ...
                          //$(this).html('<i class=\"fa-solid fa-cart-plus\" style=\"font-size:26px;\"></i>&nbsp;&nbsp;<span style=\"top: -3px; position: relative;\">В ЗАКАЗ</span>');
                          //$(this).html("1111");
                        } else {
                          $(this).addClass('active');
                        }
                      ...
                      $('.series_products__button.cart').addClass('passive');
                    }
                  }
                }, 1000);
                break;
...
//          });
      ...
      if (this.urlGetVars['management'] != null) {
        this.filterSelectedmanagement = this.urlGetVars['management'];
      }
      ...
      if (this.urlGetVars['poe'] != null) {
        if (this.urlGetVars['poe'] = 'yes') {

          this.filterSelectedpoe = true;
        }
      }
      ...
      if (this.urlGetVars['HddSATA'] != null) {
        if (this.urlGetVars['HddSATA'] = 'yes') {
          this.filterSelectedHddSATA = true;
        }
      }
      if (this.urlGetVars['HddmSATA'] != null) {
        if (this.urlGetVars['HddmSATA'] = 'yes') {
          this.filterSelectedHddmSATA = true;
        }
      }
      if (this.urlGetVars['HddM2'] != null) {
        if (this.urlGetVars['HddM2'] = 'yes') {
          this.filterSelectedHddM2 = true;
        }
      }
      if (this.urlGetVars['HddPCIE'] != null) {
        if (this.urlGetVars['HddPCIE'] = 'yes') {
          this.filterSelectedHddPCIE = true;
        }
      }
      if (this.urlGetVars['plast'] != null) {
        if (this.urlGetVars['plast'] = 'yes') {
          this.filterSelectedPlast = true;
        }
      }
      if (this.urlGetVars['alum'] != null) {
        if (this.urlGetVars['alum'] = 'yes') {
          this.filterSelectedAlum = true;
        }
      }
      if (this.urlGetVars['plastalum'] != null) {
        if (this.urlGetVars['plastalum'] = 'yes') {
          this.filterSelectedPlastAlum = true;
        }
      }
      ...
      if (this.urlGetVars['ethernets_fix'] != null) {
        let url_str_ethernets_fix = this.urlGetVars['ethernets_fix'];
        let str_ethernets_fix = url_str_ethernets_fix.replace(/%20/g, " ");
        let arrayethernets_fix = str_ethernets_fix.split(',');
        if (arrayethernets_fix.length > 0) {
          this.filterSelectedethernets_fix = arrayethernets_fix.slice(0);
        }
      }
      ...
      this.filterSelectedRangerammax_min_start = parseInt(document.querySelector(".vue-data .filter_rammax_min").getAttribute("data-value"));
      this.filterSelectedRangerammax_max_start = parseInt(document.querySelector(".vue-data .filter_rammax_max").getAttribute("data-value"));
      this.filterSelectedRangerammax_min = this.filterSelectedRangerammax_min_start;
      this.filterSelectedRangerammax_max = this.filterSelectedRangerammax_max_start;

      this.filterSelectedRangeUSB_min_start = parseInt(document.querySelector(".vue-data .filter_USB_min").getAttribute("data-value"));
      this.filterSelectedRangeUSB_max_start = parseInt(document.querySelector(".vue-data .filter_USB_max").getAttribute("data-value"));
      this.filterSelectedRangeUSB_min = this.filterSelectedRangeUSB_min_start;
      this.filterSelectedRangeUSB_max = this.filterSelectedRangeUSB_max_start;
      ...
      */
      ...
      const cookie_view_sort = this.getCookie('section_catalog_view_sort_' + this.current_section);
      ...
      if (this.urlGetVars['rammax_range_min'] != null) {
        this.filterSelectedRangerammax_min = parseFloat(this.urlGetVars['rammax_range_min']);
      }
      if (this.urlGetVars['rammax_range_max'] != null) {
        this.filterSelectedRangerammax_max = parseFloat(this.urlGetVars['rammax_range_max']);
      }

      if (this.urlGetVars['USB_range_min'] != null) {
        this.filterSelectedRangeUSB_min = parseFloat(this.urlGetVars['USB_range_min']);
      }
      if (this.urlGetVars['USB_range_max'] != null) {
        this.filterSelectedRangeUSB_max = parseFloat(this.urlGetVars['USB_range_max']);
      }
      ...
      $("#rammax-slider").slider({
        range: true,
        min: vue_context.filterSelectedRangerammax_min_start,
        max: vue_context.filterSelectedRangerammax_max_start,
        values: [vue_context.filterSelectedRangerammax_min, vue_context.filterSelectedRangerammax_max],
        step: 1,
        slide: function (event, ui) {
          vue_context.filterSelectedRangerammax_min = ui.values[0];
          vue_context.filterSelectedRangerammax_max = ui.values[1];
        },
        stop: function (event, ui) {
          vue_context.filterChanged();
        }
      ...
      $("#USB-slider").slider({
        range: true,
        min: vue_context.filterSelectedRangeUSB_min_start,
        max: vue_context.filterSelectedRangeUSB_max_start,
        values: [vue_context.filterSelectedRangeUSB_min, vue_context.filterSelectedRangeUSB_max],
        step: 1,
        slide: function (event, ui) {
          vue_context.filterSelectedRangeUSB_min = ui.values[0];
          vue_context.filterSelectedRangeUSB_max = ui.values[1];
        },
        stop: function (event, ui) {
          vue_context.filterChanged();
        }
