...
?>
<div class="<? if ( defined('SERVER_RENDERING')) {echo " IS_SERVER_RENDERING ";} else { echo " IS_NOT_SERVER_RENDERING "; }?> series_products_tiles">
  <?
    ...
    <div class="td_buttons">
          ...
          <div class="price_block_wrapper">
            <div class="price_block">
              ...
              <?
                                        if ($usd_currency) {
                                            ?>
              <span><span class="value"><? echo intval($product['retail_price'] / $usd_currency); ?>&nbsp;$</span></span> <span class="rub_price">
              <?
      ...
      <div class="buttons_panel">
        ...
        <button title="Добавить в заказ" class="series_products__button cart" @click="add_too_box"
                                data-model="<?= $product["model"]; ?>" data-box="cart"><i class="fa-solid fa-cart-plus" style="font-size: 26px"></i><span style="position: relative;top: -3px; font-size: 18px;">&nbsp;&nbsp;&nbsp;В&nbsp;ЗАКАЗ</span></button>
      </div>
    </div>
  </div>
  <? }
