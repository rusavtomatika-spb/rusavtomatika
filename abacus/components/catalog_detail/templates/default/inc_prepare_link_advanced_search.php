...
/*        case "cloud_hmi":
    ...
    switch ($product["brand"]) {
        case "Spiktek":
            $link_advanced_search .= '<br><br><a class="button is-success is-outlined find_similars" href="/srav_spiktek_weintek.php"><span class="link_advanced_search_icon">Таблица сравнения Weintek iP и СПИКТЕК СТК</span></a>';
            break;
        default:
            $link_advanced_search .= '';
            break;
