console.log($('#vue_app_news').length);
var app = new Vue({
    el: '#vue_app_news',
    data: {
        url: {
            newslist_news: '/abacus/components/newslist/templates/news/ajax_newslist_news.php?',
            crud: '/abacus/components/newslist/templates/news/ajax_crud.php?',
            save_cash: '/abacus/components/newslist/templates/news/ajax_send_cache.php?',
        },
        arr_filtered_items: [],
        arr_pager_items: [],
        arr_brands: [],
