...
CoreApplication::add_script($current_folder_url . "/newslist_blog_scripts.js");

global $TITLE;
$TITLE = "Блог - автоматизация производств, АСУТП, Weintek, IFC, Aplex, eWON, Samkoon";
CoreApplication::add_breadcrumbs_chain("Блог", "/blog/");
...
<div id="vue_app_blog" style="display: none">
                ...
                <div v-if="edit_panel_show" class="edit_panel">
                    ...
                    <div class="edit_panel_item img_wrap">
                        ...
                        <div style="padding: 10px">
                            ...
                            <input type="file" accept="image/jpeg,image/png" id="image_file" ref="file"
    ...
    <div class="component_newslist">
        ...
        <div class="component_wrapper" v-cloak>
            <div class="row">
                <div class="col-md-12"><h1 style="margin:0 auto 30px; text-align: center">Блог - автоматизация промышленности, АСТП</h1></div>
                <div class="col-md-12">
                            ...
                            <div class="text_wrapper">
                                <div class="title">
                                    <a :href="product_item.link">
                                        ...
                                        <span class="date">{{product_item.date}}</span>
                                        </div>
                                   
                                </div>
                                <div class="text" v-html="product_item.stext" style="margin-top: 8px;"></div>
                                <div class="item_buttons">
                                    <a class="detail_link" :href="product_item.link">Читать ></a>
                                </div>
                            </div>
                            <?
                            if ($edit_mode) {
                        ...
                        <div class="pager_wrapper">
                            ...
                            <div :key="pager_index" :class="['pager_item', {'active': pager_item.active}]"
                                ...
                                <a v-if="!pager_item.active"
                                   :href="(pager_item.link.length > 0)?pager_item.link:'/blog/'">{{pager_item.name}}</a>
