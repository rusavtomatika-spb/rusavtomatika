var app = new Vue({
    ...
    data: {
        url: {
            newslist_articles: '/abacus/components/newslist/templates/articles/ajax_newslist_articles.php?',
            crud: '/abacus/components/newslist/templates/articles/ajax_crud.php?',
            save_cash: '/abacus/components/newslist/templates/articles/ajax_send_cache.php?',
        },
        arr_filtered_items: [],
        arr_pager_items: [],
        arr_brands: [],
