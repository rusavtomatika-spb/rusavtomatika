...
$rows = get_rows_from_table("`articles`");
...
if (!$do_not_show_pager) {
    $rows = get_rows_from_table("`articles`", "", $filter_str, "id DESC", $offset . "," . $number_elements_per_page);
}else{
    $rows = get_rows_from_table("`articles`", "", $filter_str, "id DESC");
}
