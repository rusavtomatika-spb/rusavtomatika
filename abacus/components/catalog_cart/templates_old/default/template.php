            ...
            <div class="col-lg-12">
                ...
                <div class='catalog_cart__warning'>
                    ...
                    <p>При необходимости Вы можете уточнить <b>наличие</b> товара по Вашему заказу, условия
                        ...
                        <b>доставки</b>, возможную <b>скидку</b>.</p>
                        ...
                        <div class="series_products">
                            ...
                            if (isset($series["products"]) and is_array($series["products"])) {
                                ...
                                foreach ($series["products"] as $product) {
                                    ...
                                    <div class="tr columns tr_product_<?= $product["model"]; ?> is-centered">

                                        <div class="column td_preview_image is-narrow">
                                        ...
                                        <div class="column td_model is-2"><a href="<?= $product["link_detail_page"]; ?>"><span

                                                        class="model"><? echo $diagonal . " " . $product["short_name"] . " " . $product["brand"] . " " . $product["model"]; ?></span></a>

                                        </div>

                                        <div class="column td_short_description is-4">
                                        ...
                                        <div class="column td_onstock is-narrow">
                        ...
                        <div class="columns block_order__flex_block">
                            ...
                            <div class="column">
                                ...
                                <div class="oformit_zakaz_contact_block">
                                    ...
                                    <form class="fileform" action="/abacus/components/catalog_cart/ajax_upload_file.php" method="post"
