        ...
        <table class="series_products">
          <tbody>
            ...
            <tr class="tr_product_<?= $product["model"]; ?>">
              <td class="td_preview_image" style="width: 180px;"><a href="<?= $product["link_detail_page"]; ?>">
              ...
              <td width="70%"><a href="<?= $product["link_detail_page"]; ?>"><span class="model" style="font-size: 1.3em; font-weight: 600;"><? echo $diagonal . " " . $product["short_name"] . " " . $product["brand"] . " " . $product["model"]; ?></span></span></a> <a href="<?= $product["link_detail_page"]; ?>">
                <div>
				<span class="preview_text"><?= $product["preview_text"]; ?></span>  
				  ; <span>
                  ...
                  <tbody>
                    ...
                    <tr height="40">
                      <td class="dost_text" colspan="2"><br>
                        ...
                        Вы можете указать ИНН или прикрепить файл с реквизитами:<br>
                        <br></td>
                    </tr>
                    <tr height="40">
