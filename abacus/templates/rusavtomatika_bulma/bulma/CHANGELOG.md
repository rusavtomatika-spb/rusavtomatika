...
- рџЋ‰ #1624 Add some common photography aspect ratios and portrait ratios
- рџЋ‰ #1747 New `$custom-colors` and `$custom-shades` variable for adding your own colors and shades to Bulma's `$colors` and `$shades` maps respectively
...
- рџЋ‰ Rounded buttons, inputs, pagination and toggle tabs
...
- рџЋ‰ [List of buttons](https://bulma.io/documentation/elements/button/#list-of-buttons)
- рџЋ‰ #1235 Support for five column grid: `.is-one-fifth, .is-two-fifths, .is-three-fifths, .is-four-fifths`
- рџЋ‰ #1287 New `.is-invisible` helper
- рџЋ‰ #1255 New `.is-expanded` modifier for `navbar-item`
- рџЋ‰ #1384 New `.is-centered` and `.is-right` modifiers for `tags`
- рџЋ‰ #1383 New `.is-empty` modifier for `file`
- рџЋ‰ #1380 Allow `.is-selected` class on `<td>` and `<th>` tags
...
- рџЋ‰ #280 [File upload element](https://bulma.io/documentation/form/file/)
...
- рџЋ‰ [List of tags](https://bulma.io/documentation/elements/tag/#list-of-tags)
