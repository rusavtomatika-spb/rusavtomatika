...
(function () {
    ...
    function Eve(e, evTyp, fn) {
        if (e.addEventListener)
            e.addEventListener(evTyp, fn, false)
        else if (e.attachEvent)
            e.attachEvent('on' + evTyp, fn)
        else
            e['on' + evTyp] = fn
    }
        ...
        if (typeof ob !== "object") {
            if ((typeof ob === "undefined" || ob == 0 || ob == 1) && Nod(a.id)) { // Close
                if (a.hide == 1) {
                    if (typeof delim !== "string")
                        Nod(a.id).style.display = "none";
                    else
                        Nod(delim).style.display = "none";
                }
                return false;
            }
            if (ob == 2 || ob === "now") { // Return Now
                ...
                if (m < 10)
                    m = "0" + m;
                if (a.order == 1)
                    return y + a.delim + m + a.delim + d;
                if (a.order == 2)
                    return m + a.delim + d + a.delim + y;
                else
                    return d + a.delim + m + a.delim + y;
            }
        }
        a.o = Nod(ob);
        a.f = function () {
        ...
        xCal.f = function (a) {
            ...
            if (j > 0) { // ? &larr;
                ...
                if (j > 1) {
                    ...
                    ca += '<td class="cal-l" title="' + lang[a.lang].pre + ' ' + lang[a.lang].mo[mm] + '"><b><</b></td>';
            }
            ...
            if (DNlast > 0) { // ? &rarr;
                ...
                if (DNlast < 6) {
                    ...
                    ca += '<td class="cal-r" title="' + lang[a.lang].nex + ' ' + lang[a.lang].mo[mm] + '"><b>></b></td>';
            }
            ...
            if (k) { // a.now
                ...
                k.onclick = function () {
                    ...
                    if (a.dop != "")
                        dop = " " + a.dop;
                    if (a.o)
                        a.o.value = xCal.value = this.innerHTML + dop; // xCal(2, a);
                    if (a.hide == 1) {
                    ...
                    a.syear = a.year;
                    if (typeof a.fn === "function")
                        a.fn(this.innerHTML, a);
                    else if (typeof a.fn === "string" && a.fn !== "")
                        eval(a.fn + "('" + this.innerHTML + "');");
                    if (a.hide != 1)
                        xCal.f(a); //xCal(a.id, a);
                }
            }
    ...
    xCal.gDop = function (a) {
        ...
        if (typeof a.o.value === "undefined" || a.o.value === "")
            return a;
    ...
    xCal.gDat = function (a) {
        ...
        if (a.month > -1) {
            if (a.year < 0)
                a.year = D.getFullYear();
            if (a.dat > 0)
                D.setFullYear(a.year, a.month, a.dat);
            else
                D.setFullYear(a.year, a.month);
        }
        a.year = D.getFullYear();
        a.month = D.getMonth();
        a.dat = D.getDate();
    ...
    xCal.all = function (cl, delim, order) {
        ...
        if (document.getElementsByClassName)
            ...
            oo = document.querySelectorAll("." + cl);
        if (oo.length < 1)
            return;
