  ...
  <div class="page_width_universal">
    ...
    <div class="columns is-multiline">
      <div class="column is-9-desktop is-12-tablet">
        <h3 id="ebpro">Дистрибутивы Easybuilder Pro 6.xx.xx.xxx</h3>
        <br>
        <?
        ...
        <div class="folded-table-wrapper">
          <table class="table is-bordered is-striped is-fullwidth">
            ...
            <tr>
              ...
              if ( $item[ 3 ] != "" ) {
                ...
                <a target="_blank" title="Скачать файл"
                                             href="/soft/EBPro/release_notes/<?= $item[3] ?>">
                <?= $item[3] ?>
                </a>
                <?
                }
            ...
            <?
				  ...
				  if ($item[3] != '') {
					  $rnotes = '/soft/EBPro/release_notes/'.$item[3];
				  } else {
					  $rnotes = '';
				  }
            $old_ebpro[] = [ 'url' => $item[2], 'fsize' => $item[1], 'rnotes_url' => $rnotes, 'rnotes_name' => $item[3], 'fname' => $item[0], 'mod_data' => $mod_data ]; // добавить файл в массив
            }
            }
  file_put_contents( $_SERVER[ 'DOCUMENT_ROOT' ] . '/documents__/old_ebpro.txt', json_encode( $old_ebpro ) );
//                              echo "<pre>";
//                            var_dump( $old_ebpro );
//                            echo "</pre>";
      ...
      <div class="column is-3-desktop is-12-tablet">
        <div class="block_padding">
          ...
          <p><a class="download_pdf" href='/manuals/EBPro/EasyBuilderPro_V60901_UserManual_eng.pdf'>Руководство для
            EasyBuilder Pro 6.09.01.322 (Eng)</a></p>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left"><a class="download_zip"
                                   ...
                                   href="http://www.rusavtomatika.com/soft/EB8000/EB8000_setup.zip"> EB8000_setup.zip</a></td>
                <td>21-12-2016</td>
                <td>122&nbsp;МБ</td>
              </tr>
              <tr>
                ...
                <td style="text-align: left"><a class="download_zip"
                                   title="Скачать Дистрибутив EasyBuilder 8000 4.66.02.016 (рус)" target="_blank"
                                   href="http://www.rusavtomatika.com/soft/EB8000/EB8000V46512.zip"> EB8000V46512.zip</a></td>
                <td>03-04-2015</td>
                <td>101&nbsp;МБ</td>
              </tr>
              <tr>
                ...
                <td style="text-align: left"><a class="download_pdf"
                                   href="/manuals/UserManualEB8000.pdf">UserManualEB8000.pdf</a></td>
                <td>08-02-2016</td>
                <td>18&nbsp;МБ</td>
              </tr>
            </tbody>
