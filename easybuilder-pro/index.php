...
$CANONICAL = "https://www.rusavtomatika.com/easybuilder-pro/";
...
';
global $extra_styles;
$extra_styles = '<link rel="stylesheet" type="text/css" href="easybuilder-pro.css" />';
...
//$arrArchive_ebpro_setup = CUtilities::kama_parse_csv_file("https://www.rusavtomatika.com/upload_files/soft/EBPro/ebpro_arc.csv", 'UTF-8');
...
if (EX != "_") {
    ...
    include "content_old_template.php";
}
