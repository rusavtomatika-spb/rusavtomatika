...
$TITLE = 'Политика конфиденциальности | ООО «РУСАВТОМАТИКА»';
$DESCRIPTION = 'Политика обработки персональных данных ООО «РУСАВТОМАТИКА». Условия использования сайта и защиты персональной информации.';
$KEYWORDS = 'политика конфиденциальности, персональные данные, обработка данных, защита информации, РусАвтоматика';
...
$extra_openGraph = array(
    ...
    "openGraph_title" => "Политика конфиденциальности | ООО «РУСАВТОМАТИКА»",
