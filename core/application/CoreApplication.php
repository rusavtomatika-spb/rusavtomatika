...
class CoreApplication
{
    ...
    {
        self::$arrScripts[] = $path_to_script."?".refresh_styles_and_scripts;
    }
...
';
    ...
    public static function include_component($arguments)
    {
        ...
        include $_SERVER["DOCUMENT_ROOT"] . "/core/components/{$arguments["component"]}/component.php";
    }
    ...
    public static function include_template($arguments)
    {
        ...
        include $_SERVER["DOCUMENT_ROOT"] . "/core/components/$component/templates/$template/template.php";
    }
