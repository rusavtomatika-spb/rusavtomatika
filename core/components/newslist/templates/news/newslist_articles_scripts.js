var app = new Vue({
    ...
    data: {
        url: {
            newslist_news: '/core/components/newslist/templates/news/ajax_newslist_news.php?',
            crud: '/core/components/newslist/templates/news/ajax_crud.php?',
            save_cash: '/core/components/newslist/templates/news/ajax_send_cache.php?',
        },
        arr_filtered_items: [],
        arr_pager_items: [],
        arr_brands: [],
        ...
        edit_element_button__clicked(item) {
            ...
            setTimeout(() => {
                    ...
                    tinymce.init({
                        ...
                        height: "1000",
                        theme: 'silver',
                        plugins: ['code', 'image', 'anchor','fullscreen', 'table', 'link'],
                        toolbar: 'undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | outdent indent | table | link | image | fullscreen | code',
                        image_class_list: [
                            {title: 'Нет', value: ''},
                            {title: 'Выровнять влево', value: 'image-align-left'},
                            {title: 'Выровнять вправо', value: 'image-align-left'}
                        ],
