...
$TITLE = "Новости Weintek, IFC, Aplex, eWON, Samkoon";
$DESCRIPTION = "Последние новости от компании Русавтоматика: Автоматизация производства, панели оператора, промышленные компьютеры, Индустрия 4.0.";
