...
global $TITLE;
$TITLE= "Уцененные товары - Панели оператора, Панельные компьютеры, Промышленные компьютеры full IP65, Встраиваемые компьютеры, Промышленные мониторы, VPN-роутеры, Контроллеры (PLC), Модули ввода-вывода, Блоки питания";
    ...
    ?>
        <div class="component_wrapper">
            <div class="row">
                ...
                <div class="col-md-12"><h1 style="margin:0 auto 30px; text-align: center">Уцененные товары</h1></div>
                <?php
                foreach ($rows as $row) {
                    ?>
                    <div class="col-md-3">
