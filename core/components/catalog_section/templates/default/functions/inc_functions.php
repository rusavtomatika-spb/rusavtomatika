...
function print_product_list($products, $view_mode)
{
    ...
    switch ($view_mode) {
        case 'table':
            include $_SERVER["DOCUMENT_ROOT"]."/core/components/catalog_section/templates/default/templates/inc.template_list_of_products_table.php";

            break;
        case 'list':
            include $_SERVER["DOCUMENT_ROOT"]."/core/components/catalog_section/templates/default/templates/inc.template_list_of_products_list.php";
            break;
    }
    ?></div><?
}
