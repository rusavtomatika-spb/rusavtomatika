...
global $SEO_URL;
global $UPPER_SEO_TEXT, $LOWER_SEO_TEXT;
        ...
        <div class="component_wrapper">
            ...
            <div class="columns is-gapless">
                ...
                <div class=" column is-10-desktop is-12-tablet column_content">
                    ...
                    if($UPPER_SEO_TEXT){
                        ?>
                        <div class="UPPER_SEO_TEXT"><?=$UPPER_SEO_TEXT?></div>
                        <?
                    }
                    ...
                    <div class="panel_chosen_filters"
                        ...
                        <span class="item" v-if="filterSelectedCodesys"><span>Codesys <span
                                        @click="clear_filter_item('filterSelectedCodesys')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedVesa"><span>VESA <span
                                        @click="clear_filter_item('filterSelectedVesa')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedSdcard"><span>SD-карта <span
                                        @click="clear_filter_item('filterSelectedSdcard')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedCmtviewer"><span>CMT Viewer <span
                                        @click="clear_filter_item('filterSelectedCmtviewer')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedWebView"><span>WebView <span
                                        @click="clear_filter_item('filterSelectedWebView')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedScreenless"><span>Безэкранные <span
                                        @click="clear_filter_item('filterSelectedScreenless')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedPlcWebBrowser"><span>PLC Web-Browser <span
                                        @click="clear_filter_item('filterSelectedPlcWebBrowser')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedCameraIP"><span>IP-камера <span
                                        @click="clear_filter_item('filterSelectedCameraIP')"
                                        class="button_clear_filter"> </span></span></span>

                        <span class="item" v-if="filterSelectedCameraUSB"><span>USB-камера <span
                        ...
                        <span class="item" v-if="filterSelectedAvailablity > 0"><span>доступность: <b
                                        ...
                                        class="button_clear_filter"> </span></span></span>
                        <span class="item" v-if="filterSelectedSensorType!=''"><span>тип сенсора: <b
                        ...
                        <span class="item" v-if="filterSelectedСase_material!=''"><span>материал корпуса: <b
                                        v-if="filterSelectedСase_material == 'aluminium'">Алюминий</b>
                                <b v-if="filterSelectedСase_material == 'plastic'">Пластик</b>
                                <b v-if="filterSelectedСase_material == 'plastic+aluminium'">Пластик+Алюминий</b>
                                <span
                                        @click="clear_filter_item('filterSelectedСase_material','')"
                                        class="button_clear_filter"> </span></span></span>
                    ...
                    <div class="section_list_view_mode_button_wrapper" v-cloak>
                        ...
                        <div class="is-hidden-touch section_list__set_diagonal_span"
                             v-if="section_list__set_diagonal_span_show">
                    ...
                    <div class="component_catalog_section__panel_of_products_wrapper">
                        ...
                        <!--div class="component_catalog_section__panel_of_products" v-html="html_filtered_products">!!!!!!!!!2222222222</div-->
                        <?
