...
$extra_openGraph = Array(
    "openGraph_image" => "https://www.rusavtomatika.com".$arResult["picture_preview"],
...
CoreApplication::add_breadcrumbs_chain("Новые продукты", "/new_products".EX."/");
    ...
    <div class="component_newslist_detail">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="detail_text">
                        <? if ($arResult["picture_detail"] != ""): ?>
                            <img itemprop="image" alt="<?= $arResult["alt"] ?>" class="news-img-big"
                                 src="<?= $arResult["picture_detail"] ?>">
                        <? endif; ?>
                        <?= $arResult["text_detail"] ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <a class="button_window_history_back" onclick="window.history.back();return false;"
               href="/<?= $arguments["root_folder_url"] ?>/">Возврат к списку</a>
        </div>
    </div>
</div>
