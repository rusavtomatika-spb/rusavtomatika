            ...
            <ul class="glide__slides">
                ...
                for ($x = 0; $x < $count; $x++) {
                    if (isset($arResult["items"][$x])) {
                        ...
                        include $_SERVER["DOCUMENT_ROOT"] . "/core/components/news_slider/templates/template_common_item/template_common_item1.php";
                    }
                }
                $item["url_page_detail"] = "/news/";
                $item["name"] = "—мотреть все новости";
                include $_SERVER["DOCUMENT_ROOT"] . "/core/components/news_slider/templates/template_common_item/template_common_item1_link_to_all.php";
                $item["url_page_detail"] = "/articles/";
                $item["name"] = "—мотреть все статьи";
                include $_SERVER["DOCUMENT_ROOT"] . "/core/components/news_slider/templates/template_common_item/template_common_item1_link_to_all.php";
                ?>
            </ul>
        </div>
