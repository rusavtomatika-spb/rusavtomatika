...
var app = new Vue({
    ...
    data: {
        url: {
            //newslist_articles: '/core/components/documentation/templates/weintek_easybuilder_instrukciya_na_russkom/ajax_пуе_articles.php?',
            crud: '/core/components/documentation/templates/weintek_easybuilder_instrukciya_na_russkom/ajax_crud.php?',
            save_cash: '/core/components/documentation/templates/weintek_easybuilder_instrukciya_na_russkom/ajax_send_cache.php?',
        },
        arr_menu_items: [],
        arr_pager_items: [],
        arr_brands: [],
