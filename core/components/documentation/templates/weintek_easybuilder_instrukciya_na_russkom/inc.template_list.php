...
CoreApplication::add_script($current_folder_url . "/scripts.js?" . rand());
...
CoreApplication::add_breadcrumbs_chain("–уководство пользовател€ EasyBuilderPro", "/weintek-easybuilder-instrukciya-na-russkom2/");
?>
