...
if($current_article["title"] != ""){
    $TITLE = $current_article["title"]." EasyBuilder на русском –уководство пользовател€ | Weintek EasyBuilderPro V6.01.02";
}
...
<div class="component_ebpro_instruction_rus_title">–уководство пользовател€ EasyBuilderPro V6.01.02
    на русском €зыке</div>
...
<div id="vue_app_articles" v-cloak>
    ...
    <div id="component_ebpro_instruction_rus">
        <p style="background: #f0f0f0;padding: 20px;">
            ѕредставл€ем вам <b>частичный перевод с английского €зыка</b> "–уководства пользовател€ EasyBuilderPro". Ќовые переведенные главы будут постепенно добавл€тьс€ в этом разделе.
            ќригинальный документ на английском €зыке вы можете найти тут : <a href="/weintek-easybuilderpro-user-manual-en/">Manual EasyBuilderPro (En)</a>
        </p>
