                    ...
                    <div class="columns is-multiline">
                        ...
                        <div class="column  <? // if (isset($arResult['certificate_preview_picture']) and $arResult['certificate_preview_picture'] != '') { echo "is-8"; } ?> ">
                            <div class="component_catalog_brand__head">
                                ...
                                <div class="component_catalog_brand__logo">
                                    <img src="<?= $arResult['preview_picture'] ?>" alt="<?= $arResult['name'] ?>">
                                </div>
                            </div>
                            <?
                    ...
                    <div class="is-flex is-justify-content-right">
                        <ul class="brand_menu  has-background-light">
                            <? if ($_SERVER['REQUEST_URI'] == '/weintek/'): ?>
                                <li><span>Weintek</span></li><? else: ?>
                                <li><a href="/weintek/">Weintek</a></li><? endif; ?>
                            <? if ($_SERVER['REQUEST_URI'] == '/ifc/'): ?>
                                <li><span>IFC</span></li><? else: ?>
                                <li><a href="/ifc/">IFC</a></li><? endif; ?>
                            <? if ($_SERVER['REQUEST_URI'] == '/aplex/'): ?>
                                <li><span>Aplex</span></li><? else: ?>
                                <li><a href="/aplex/">Aplex</a></li><? endif; ?>
                            <? if ($_SERVER['REQUEST_URI'] == '/samkoon/'): ?>
                                <li><span>Samkoon</span></li><? else: ?>
                                <li><a href="/samkoon/">Samkoon</a></li><? endif; ?>
                            <? if ($_SERVER['REQUEST_URI'] == '/ewon/'): ?>
                                <li><span>eWON</span></li><? else: ?>
                                <li><a href="/ewon/">eWON</a></li><? endif; ?>
                            <? if ($_SERVER['REQUEST_URI'] == '/faraday/'): ?>
                                <li><span>Faraday</span></li><? else: ?>
                                <li><a href="/faraday/">Faraday</a></li><? endif; ?>
                ...
                if (isset($arResult['certificate_preview_picture']) and $arResult['certificate_preview_picture'] != '') {
                    ...
                    <div class="column is-12">
                        ...
                        <a class="block_sertificates__img_sertificate_link"
                           href="<?= $arResult['certificate_detail_picture'] ?>" target="_blank">
                            <img src="<?= $arResult['certificate_detail_picture'] ?>" alt="">
                        </a>
                    </div>
                    <?
                }
