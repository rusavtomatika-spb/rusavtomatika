...
$outs = "<h1 class=series_name>ѕромышленные мониторы ( встраиваемые, сенсорные )</h1>";
...
$keywords = 'монитор, IFC, LED, 5,7&Prime;, 22&Prime; диагональ, VGA, DVI, USB, сенсор, резистивный, подстветка, наработка, операторский, промышленный, 8&Prime;, 10.4&Prime; , 15&Prime;, 17&Prime;, 19&Prime;, 22&Prime;';
$description = 'ѕромышленные LED мониторы IFC с диагональю 5,7&Prime;-22&Prime; с напр€жением питани€ 12 V, качество, простота, функциональность, тонкий корпус, IP65 передней панели, входы VGA, DVI, Audio, USB-выход и умеренные цены';
