...
$extra_openGraph = Array(
    "openGraph_image" => "https://www.rusavtomatika.com/upload_files/images/openGraph_images/CloudHMI.png",
    "openGraph_title" => "Weintek серия cMT",
...
?>
    ...
    <div class="color_text_block"  style="text-align: left;">
        ...
        но также такие продукты как: шлюзы данных, облачные серверы, панельные компьютеры, программируемые контроллеры.
         <br><br><a href='/articles/opisanie-serii-cmt.php/'>Подробное описание серии cMT</a>
    </div>
    ...
    <ul id="table_of_contents"  style="text-align: center;">
        ...
        <li><a href="#anchor_monitor_cloud_hmi">Экраны облачного интерфейса <span>&#8681</span></a></li>
        <li><a href="#anchor_controllers">Контроллеры <span>&#8681</span></a></li>
    </ul>
    </div>
...
?>
    <h2 id="anchor_controllers" class='h2_style1'>Контроллеры</h2>
<?
$component->show(array(
    "component_name" => "news.list",
    "component_template" => "main_page_type",
