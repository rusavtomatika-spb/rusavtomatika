...
if(!empty($r->codesys)){$technological["CODESYS"] = $r->codesys;}
if(!empty($r->mqtt)){$technological["MQTT"] = $r->mqtt;}
if(!empty($r->opc_ua)){$technological["OPC UA"] = $r->opc_ua;}
if($r->matrix == 'IPS'){$technological["IPS"] = $r->matrix;}
...
<style>#dd {text-align: center;} #dd img {max-height:300px;max-width:400px;} h2 {font-size: 14px;
color: gray;
...
if ($link_advanced_search):
    ...
    <table width=100%>
        <? if ($r->discontinued != '1') { ?>
            <tr>
                <td><div class=but_wr><div  class='zakazbut' idm='<?= $r->model ?>' onclick='v_korzinu(this)'><span>В корзину</span></div></div> </td>
        ...
        <tr>
            ...
            <td colspan=2><div class=but_wr><div class='link_advanced_search_wrapper'><?= $link_advanced_search ?></div></div>  </td>
...
if ($r->modbus_support != '') {
    if ($r->modbus_support == 'Есть') {
        $os1 .= "<tr><td valign=center>$im </td><td valign=middle $he>Поддержка MODBUS TCP/IP Gateway </td></tr>";
    } else {
        $os1 .= "<tr><td valign=center>$im </td><td valign=middle $he>Поддержка MODBUS " . $r->modbus_support . "</td></tr>";
    }
}
if ($r->opc_ua != '') {
...
if (!empty($r->text_detail)) {
    ...
    <tr><td width=30><?=$im?></td><td <?=$he?>> <?=$quality?></td></tr>
        <?if($r->matrix == 'IPS'):?>
            <tr><td width=30><?=$im?></td><td <?=$he?>>Тип матрицы <?=$r->matrix?>, широкие углы обзора</td></tr>
        <?endif;?>
...
<?if ($r->diagonal > 0):?>
            <div style="width:90%;">
                ...
                <?=$table_start?>
    <tr>
        <td class=par_name1>Диагональ</td><td class=par_val1 ><?=$r->diagonal?>&#8243; <?=$without?></td>
    </tr>
    <tr>
        <td class=par_name1>Разрешение</td><td class=par_val1 ><?=$r->resolution?></td>
    </tr>

    <?if(!empty($r->matrix)):?>
        <tr>
            <td class=par_name1>Тип матрицы</td><td class=par_val1 ><?=$r->matrix?></td>
        </tr>
    <?endif;?>
    <?=$display_char?>
    <?=$pixel_pitch?>
...
if ($r->type == 'monitor' and $r->series == 'cMT') {
   ...
   <?if(!empty($r->usb_host)):?>
    ...
    $interfaces = $ethernet_full . $wifi . $serial_full . $usb_host . $usb_client .
            ...
            $ts_usb . $s_video;
    if ($r->brand == 'Weintek') {
        $interfaces .= $opc_ua . $mqtt2 . $modbus . $mpi;
    };
};
...
if ((($r->os != "") or ( $r->type != 'monitor'))and $r->type != 'monitor_cloud_hmi') {
 ...
 ";
    elseif ($r->type != 'monitor' and $r->model != 'cMT-iV5') {
        $sp_data1 .= "
...
<?=$usb_drv?>
    ...
    <?if($r->codesys != 0):?>
        <tr><td class=par_name1>Поддержка CODESYS</td><td class=par_val1>Есть</td></tr>
    <?endif;?>
...
$komplect = '';
if ($r->diagonal == '7' or ( $r->diagonal >= 9 and $r->diagonal < 10)) {
...
var nnew = 'http://'+location.hostname+urlbase+'?tab='+dat;
                    ...
                    <div class="blockofcols_row" style="margin-bottom:25px;">
                            ...
                            <div class="col-3">
                                <div class="block_item_info">
                                    <span class="link_advanced_search block_item_info-btn" idm="HF-07" onclick="show_backup_call(6, &quot;HF-07&quot;)">Узнать
                                        цену</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blockofcols_row">
                            <div class="col-9">
                                <a data-fancybox="gallery" href="/images/fam/HF-07/lg/HF-07_4.png">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-07/HF-07_4.png'); height: 322px;"></div>
                                </a>
                            </div>
                            <div class="col-3">
                                <div class="blockofcols_row">
                                    <div class="col-12">
                                        <a data-fancybox="gallery" href="/images/fam/HF-07/lg/HF-07_2.png">
                                            <div class="block_item-img" style="background-image:url('/images/fam/HF-07/HF-07_2.png')"></div>
                                        </a>
                                    </div>
                                    <div class="col-12">
                                        <a data-fancybox="gallery" href="/images/fam/HF-07/lg/HF-07_3.png">
                                            <div class="block_item-img" style="background-image:url('/images/fam/HF-07/HF-07_3.png')"></div>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<?$accessories = ob_get_clean();
   /* $accessories = '<div><h3>Рамка HF-07</h3>
<div style="float:left;width:400px;"><div id="dd" style="height:300px;margin-bottom:30px;"><a id="biglightbox" href="/images/fam/HF-07/lg/HF-07_4.png" rel="lightbox[2]"><span id="bigimage" title="Увеличить"><img class="lupa" src="/images/zoom.png"><img src="/images/fam/HF-07/HF-07_4.png"></span></a></div>
</div>
<table width="500px" style="font-weight:normal;margin-top:20px;">

<tbody><tr><td valign="center"><img src="/images/tick.png" width="15" style="vertical-align: middle;"> </td><td valign="middle" height="40" class="hl_text">Габариты: 227х217х36 мм</td></tr>
<tr><td width="30"><img src="/images/tick.png" width="15" style="vertical-align: middle;"> </td><td height="40" class="hl_text">Материал: Окрашенный металл / Нержавеющая сталь</td></tr>
</tbody></table>
<div style="float:left;width:500px;margin-top:20px;"><div id="dd" style="height:190px;margin-bottom:30px;"><a id="biglightbox" href="/images/fam/HF-07/lg/HF-07_2.png" rel="lightbox[2]"><span id="bigimage" title="Увеличить"><img class="lupa" src="/images/zoom.png"><img src="/images/fam/HF-07/HF-07_2.png" style="max-height: 180px"></span></a><a id="biglightbox" href="/images/fam/HF-07/lg/HF-07_3.png" rel="lightbox[2]"><span id="bigimage" title="Увеличить"><img class="lupa" src="/images/zoom.png"><img src="/images/fam/HF-07/HF-07_3.png" style="max-height: 180px"></span></a>
</div>

</div>
<img src="/images/fam/dim/HF-07.png" style="margin:auto;display:block;">
<a href="/manuals/HF-07.pdf" style="margin-top:20px;display:inline-block;">Открыть чертеж (pdf)</a>
';*/
...
<div class="block_item_title">Рамка для <?if($r->type == 'monitor_cloud_hmi'):?>экрана облачного интерфейса <?else:?>панелей оператора <?endif;?>Weintek 9.7" HF-09</div>
                        <div class="blockofcols_row" style="margin-bottom:25px;">
                            <div class="col-9">
                                <div class="block_item_text">
                                    <ul class="plc_weintek_ul_style1">
                            ...
                            <div class="col-3">
                                <div class="block_item_info">
                                    <span class="link_advanced_search block_item_info-btn" idm="HF-09" onclick="show_backup_call(6, &quot;HF-09&quot;)">Узнать
                                        цену</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blockofcols_row">
                            <div class="col-4">
                                <a data-fancybox="gallery2" href="/images/fam/HF-09/HF-09_1_lg.jpg">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-09/HF-09_1_md.jpg')"></div>
                                </a>
                            </div>
                            <div class="col-4">
                                <a data-fancybox="gallery2" href="/images/fam/HF-09/HF-09_4_lg.jpg">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-09/HF-09_4new.jpg')"></div>
                                </a>
                            </div>
                            <div class="col-4">
                                <a data-fancybox="gallery2" href="/images/fam/HF-09/HF-09_5_lg.jpg">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-09/HF-09_5_new.jpg')"></div>
                                </a>
                            </div>
                        </div>
                        <div class="blockofcols_row">
                            <div class="col-6">
                                <a data-fancybox="gallery2" href="/images/fam/HF-09/HF-09_2_lg.jpg">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-09/HF-09_2_md.jpg')"></div>
                                </a>
                            </div>
                            <div class="col-6">
                                <a data-fancybox="gallery2" href="/images/fam/HF-09/HF-09_3_lg.jpg">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-09/HF-09_3_md.jpg')"></div>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="blockofcols_row">
                            <div class="col-12">
                                <a data-fancybox="dim" href="/images/fam/HF-09/HF-09_6_lg.jpg">
                                    <div class="block_item-img" style="background-image:url('/images/fam/HF-09/HF-09_6_lg.jpg')"></div>           
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <?/*?>
    <div><h3>Рамка HF-09</h3>
        <div style="float:left;width:400px;">
            <div id="dd" style="height:300px;margin-bottom:30px;">
                <a id="biglightbox" href="/images/fam/HF-09/HF-09_1_lg.jpg" rel="lightbox[2]">
                    <span id="bigimage" title="Увеличить">
                        <img class="lupa" src="/images/zoom.png">
                        <img src="/images/fam/HF-09/HF-09_1_md.jpg">
                    </span>
                </a>
            </div>
        </div>
        <table width="500px" style="font-weight:normal;margin-top:20px;">
            <tbody>
                <tr><td valign="center"><img src="/images/tick.png" width="15" style="vertical-align: middle;"> </td><td valign="middle" height="40" class="hl_text">Габариты: 283х226х36 мм</td></tr>
                <tr><td width="30"><img src="/images/tick.png" width="15" style="vertical-align: middle;"> </td><td height="40" class="hl_text">Материал: Окрашенный металл</td></tr>
            </tbody>
        </table>
        <div style="float:left;width:500px;margin-top:20px;">
            <div id="dd" style="height:190px;margin-bottom:30px;">
                <a style="display: inline-block;text-decoration: none;margin-right: 10px;" id="biglightbox" href="/images/fam/HF-09/HF-09_4_lg.jpg" rel="lightbox[2]">
                    <span id="bigimage" title="Увеличить">
                        <img class="lupa" src="/images/zoom.png">
                        <img src="/images/fam/HF-09/HF-09_4_md.jpg" style="max-height: 180px;">
                    </span>
                </a>
                <a style="display: inline-block;text-decoration: none;margin-left: 10px;" id="biglightbox" href="/images/fam/HF-09/HF-09_5_lg.jpg" rel="lightbox[2]">
                    <span id="bigimage" title="Увеличить">
                        <img class="lupa" src="/images/zoom.png">
                        <img src="/images/fam/HF-09/HF-09_5_md.jpg" style="max-height: 180px">
                    </span>
                </a>
            </div>

            <div id="dd" style="height:190px;margin-bottom:30px;">
                <a id="biglightbox" href="/images/fam/HF-09/HF-09_2_lg.jpg" rel="lightbox[2]">
                    <span id="bigimage" title="Увеличить">
                        <img class="lupa" src="/images/zoom.png">
                        <img src="/images/fam/HF-09/HF-09_2_md.jpg" style="max-height: 180px">
                    </span>
                </a>
                <a id="biglightbox" href="/images/fam/HF-09/HF-09_3_lg.jpg" rel="lightbox[2]">
                    <span id="bigimage" title="Увеличить">
                        <img class="lupa" src="/images/zoom.png">
                        <img src="/images/fam/HF-09/HF-09_3_md.jpg" style="max-height: 180px">
                    </span>
                </a>
            </div>
        ...
        <img src="/images/fam/HF-09/HF-09_6_lg.jpg" style="margin:auto;display:block;">
...
<div id='tabs-4'>
  ...
  <?if (($r->diagonal >= 9 and $r->diagonal < 10) || ($r->diagonal == 7)):?>
<?=$komplects?>
<?endif;?>
