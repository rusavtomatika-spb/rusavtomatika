$(document).ready(function () {
    $(window).scroll(function () {
        load_content("#main_page__block_contacts", "/include/main_page/content/block_contacts_content.php");
    });
    load_content("#main_page__block_big_slider", "/include/main_page/content/block_big_banner2_content.php", 2000);
});
            ...
            setTimeout(function () {
                $.ajax({
                    ...
                    if (data.length > 0) {
                        ...
                        console.log('Ёлемент ' + block_id + ' показан');
                    }
                });
            }, timeout);
        }
