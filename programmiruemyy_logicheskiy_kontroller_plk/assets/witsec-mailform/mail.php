...
$to = "sales@rusavtomatika.com";														// To Address
$toAlt = "Belousov:maxbelousov@ya.ru";												// Additional Recipients
$from = "info@rusavtomatika.com";													// From Address
...
$template = "Получено сообщение с лендинга ПЛК<br>{formdata}<br><br>Дата: {date}<br>IP: {ip}<br><br>---<br>Удачи!";											// Mail Template
$autorespondSubjectPrefix = "Re:";			// Autorespond Form Subject Prefix
$autorespondSubject = "";						// Autorespond Custom Subject
$autorespondTemplate = "Здравствуйте, {name},<br><br>Спасибо за обращение.<br>Мы постараемся оперативно ответить.<br><br>Ваше сообщение:<br><br>{formdata}<br><br>---<br>Всего доброго!";					// Autorespond Template
