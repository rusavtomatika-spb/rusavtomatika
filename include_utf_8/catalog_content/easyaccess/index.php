...
<div id="vue_app_easyaccess">
  <div class="columns is-multiline">
    <div class="column is-3-desktop is-12-mobile">
      ...
      <ul class="tabs__guide__caption">
        ...
        <li class="button is-fullwidth" @click="change_section(2)"
                    :class="{ 'is-success': current_section==2 }">Системные требования <br>
          и установка </li>
        <li class="button is-fullwidth" @click="change_section(3)"
                    :class="{ 'is-success': current_section==3 }">Начало работы </li>
        <li class="button is-fullwidth" @click="change_section(4)"
                    :class="{ 'is-success': current_section==4 }">Управление доменом <br>
          (аккаунтом) </li>
        <li class="button is-fullwidth" @click="change_section(5)"
                    :class="{ 'is-success': current_section==5 }">Добавление панели в домен<br>
          (Trial 30 дней) </li>
        <li class="button is-fullwidth" @click="change_section(6)"
                    :class="{ 'is-success': current_section==6 }">Добавление панели в домен<br>
        </li>
        <li class="button is-fullwidth" @click="change_section(7)"
                    :class="{ 'is-success': current_section==7 }">EasyAccess 2.0 на ПК </li>
        <li class="button is-fullwidth" @click="change_section(8)"
                    :class="{ 'is-success': current_section==8 }">Ограничения </li>
      </ul>
    </div>
    <div class="column is-9-desktop is-12-mobile">
        ...
        <div class="tabs__guide  vertical">
          <div class="tabs__guide__content" v-if="current_section == 1">
            ...
            <p>EasyAccess 2.0 это сервис, с помощью которого вы можете получить доступ к вашим панелям
              ...
              (на сайте
              www.weincloud.ovh), и убедиться, что панели имеют выход в Интернет.
            ...
            <h2> Для чего нужен EasyAccess 2.0? </h2>
            <p> В последние время все больше стали появляться запросы на удаленное управление панелями
              оператора.
              ...
              знаете какой IP
              у панели? Есть несколько способов как это сделать. </p>
            ...
            <ol class="spisok">
              <li>Управлять панелью через VNC-клиент, CMT Viewer (доступна только для серий
                ...
                Вы можете видеть, что происходит на экране вашей панели, нажимать кнопки. </li>
            ...
            <p><a href="#videos">Видео-материалы по EasyAccess</a></p>
          ...
          <div class="tabs__guide__content" v-if="current_section == 2">
            ...
            <ul class="spisok">
              <li>Операционная система: Windows XP, Windows 7, Windows 8 (32 / 64бит), Windows 10 (32 /
                64бит)
                (Необходимы права администратора) </li>
          ...
          <div class="tabs__guide__content" v-if="current_section == 3">
            ...
            <ol class="spisok">
              <li>Панель оператора должна быть активирована (Если ваша панель не имеет уже активированный
                EasyAccess2.0, то обратитесь к нашим менеджерам в онлайн-чате.) </li>
              <li>Управление доменом (аккаунтом) (Пункт 4)<br>
                Должен быть создан аккаунт (Домен) на сайте <a
                                        href="https://www.weincloud.ovh">www.weincloud.ovh</a></li>
              <li>Добавление панели в домен (Пункт 6)<br>
                Если вы хотите попробовать 30 дневную версию, то
                переходите к
                (Пункт 5)<br>
                Панель оператора должна быть добавлена в Домен </li>
              <li>Добавление пользователя и открытия ему доступа к панели<br>
                Должна быть создана учетная
                запись
                Пользователя, к которой будет привязана панель оператора </li>
            ...
            <ul class="spisok">
              <li><b>Домен и администратора домена</b>
                <p>Доменом называется аккаунт, к которому привязываются панели оператора. <b>Панель оператора может быть привязана только к одному домену.</b> Администратора домена, это пользователь, который может управлять панелями оператора
                  и пользователями через веб интерфейс на сайте (<a href="https://www.weincloud.ovh">www.weincloud.ovh</a>).
              ...
              <li> <b>Пользователь</b>
                <p>Пользователь — это аккаунт, который может авторизоваться в клиентской программе
                  ...
                  которые ранее ему назначил администратор домена.</p>
              </li>
            </ul>
            ...
            <ol class="spisok">
              ...
              <li>В этом примере панели оператора сгруппированы в группы: Группа 1, Группа 2, Группа 3 и
                т.д. Панель
                оператора A принадлежит к двум группам </li>
              <li>Пользователи могут принадлежать ко многим группам. А так же иметь доступ к панелям
                оператора,
                которые не имеют группы. (Пользователь Петр и группа 1) </li>
            ...
            <p style="text-align: center"><a class="img__easyaccess"
                                                         ...
                                                         data-fancybox="gallery0"><img loading="lazy"
                                                                                       src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/mceclip1.webp"></a> </p>
            <div class="is-clearfix has-background-light mt-5">
              <div class="button is-pulled-right is-success" @click="next_section">Далее</div>
            </div>
          </div>
          <div class="tabs__guide__content" v-if="current_section == 4">
            ...
            <ol>
              <li>
                <p>Система управления доменами находится по адресу: <a href="https://www.weincloud.ovh">www.weincloud.ovh</a> </p>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery1"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/1.webp"></a> </p>
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 href="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/2.webp"
                                                                 data-fancybox="gallery1"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/2.webp"></a> </p>
              </li>
              <li>
                ...
                <p>Теперь можно авторизоваться в системе управления доменом. Для этого на главной
                  странице <a href="https://www.weincloud.ovh/">www.weincloud.ovh</a> нажмите кнопку [Domain] </p>
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 href="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/3.webp"
                                                                 data-fancybox="gallery1"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/3.webp"></a> </p>
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 href="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/4.webp"
                                                                 data-fancybox="gallery1"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/4.webp"></a> </p>
              </li>
            </ol>
              ...
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/13.webp"></a> </p>
              </li>
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/14.webp"></a> </p>
              </li>
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/15.webp"></a> </p>
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 href="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/16.webp"
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/16.webp"></a> </p>
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 href="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/17.webp"
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/17.webp"></a> </p>
              </li>
            </ol>
            <div class="is-clearfix has-background-light mt-5">
              <div class="button is-pulled-right is-success" @click="next_section">Далее</div>
          ...
          <div class="tabs__guide__content" v-if="current_section == 5">
            ...
            <ol>
              <li>
                <p>В своем домене на сайте <a href="//www.weincloud.ovh">www.weincloud.ovh</a>, на вкладке
                  "Devices" -
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery2"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/5.webp"></a> </p>
              </li>
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery2"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/6.webp"></a> </p>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery2"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/7.webp"></a> </p>
              </li>
            </ol>
            <div class="is-clearfix has-background-light mt-5">
              <div class="button is-pulled-right is-success" @click="next_section">Далее</div>
            ...
            <ol>
              ...
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/8.webp"></a> </p>
              </li>
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/9.webp"></a> </p>
              </li>
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/10.webp"></a> </p>
              </li>
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/11.webp"></a> </p>
              </li>
              <li>
                <p>В своем домене на сайте <a href="//www.weincloud.ovh">www.weincloud.ovh</a>, на вкладке
                  "Devices" -
              ...
              <li>
                ...
                <p style="text-align: center"><a class="img__easyaccess"
                                                                 ...
                                                                 data-fancybox="gallery3"><img loading="lazy"
                                                                                               src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/12.webp"></a> </p>
              </li>
            </ol>
            <div class="is-clearfix has-background-light mt-5">
              <div class="button is-pulled-right is-success" @click="next_section">Далее</div>
          ...
          <div class="tabs__guide__content" v-if="current_section == 7">
            ...
            <p style="text-align: center"><a class="img__easyaccess"
                                                         ...
                                                         data-fancybox="gallery3"><img loading="lazy"
                                                                                       src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea1.webp"></a> </p>
            <h3>Главный экран</h3>
            ...
            <p style="text-align: center"><a class="img__easyaccess"
                                                         ...
                                                         data-fancybox="gallery3"><img loading="lazy"
                                                                                       src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea2.webp"></a> </p>
              ...
              <tbody>
                ...
                <tr>
                  <td style="width: 260px;"><p style="text-align: left"><img loading="lazy"
                                                                                           src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea3.webp"> </p></td>
                  <td>Трафик домена</td>
                </tr>
                <tr>
                  <td style="width: 260px;"><p style="text-align: left"><img loading="lazy"
                                                                                           src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea4.webp"> </p></td>
                  <td>Поиск панели оператора</td>
                </tr>
                <tr>
                  <td style="width: 260px;"><p style="text-align: left"><img loading="lazy"
                                                                                           src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea5.webp"> </p></td>
                  <td> Вид: плитка/список </td>
                </tr>
                <tr>
                  <td style="width: 260px;"><p style="text-align: left"><img loading="lazy"
                                                                                           src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea6.webp"> </p></td>
                  <td>Настройки</td>
                </tr>
                <tr>
                  <td style="width: 260px;"><p style="text-align: left"><img loading="lazy"
                                                                                           src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea7.webp"> </p></td>
                  <td>Выход из текущего пользователя</td>
                </tr>
                <tr>
                  <td style="width: 260px;"><p style="text-align: left"><img loading="lazy"
                                                                                           src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea8.webp"> </p></td>
              ...
              <tbody>
                <tr style="border-bottom: none;">
                  <td><p style="text-align: left"><img loading="lazy"
                                                                     src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea9.webp"> </p></td>
                  <td><p style="text-align: left"><img loading="lazy"
                                                                     src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea10.webp"> </p></td>
                </tr>
                <tr>
                  <td>Офлайн</td>
                  <td>Онлайн</td>
                ...
                <tr style="border-bottom: none;">
                  <td><p style="text-align: left"><img loading="lazy"
                                                                     src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea11.webp"> </p></td>
                  <td><p style="text-align: left"><img loading="lazy"
                                                                     src="//www.rusavtomatika.com/upload_files/images/easyaccess20guide/ea12.webp"> </p></td>
                </tr>
                <tr>
                  <td>Соедино</td>
                  <td>Занято</td>
          ...
          <div class="tabs__guide__content" v-if="current_section == 8">
            ...
            <ul style="margin-left:25px;">
              ...
              <li>Количество доменов в которых можно зарегистрировать Панель оператора</li>
      ...
      <h2 align="center"><a href="/download/#EasyAccess20">Скачать EasyAccess 2.0</a></h2>
    </div>
  </div>
  <section> </section>
</div>
