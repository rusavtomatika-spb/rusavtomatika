...
if ( isset( $_GET[ 'action' ] ) ) {
  ini_set( 'max_execution_time', 11500 );
...
//			  echo $tmp_bufer . $attrs[ 'put' ] . '/version.txt - '.$ver.'<br>';
            ftp_put( $conn_id, '/soft/EBPro/temp/version.txt', $tmp_bufer . $attrs[ 'put' ] . '/version.txt', FTP_BINARY );
            ftp_put( $conn_id, '/soft/EBPro/temp/date.txt', $tmp_bufer . $attrs[ 'put' ] . '/date.txt', FTP_BINARY );
            //break;
          }
          if ( isset( $attrs[ 'label' ] ) && ( strpos( $attrs[ 'label' ], 'SoftwareEasyAccess' ) !== false ) ) {
            ftp_put( $conn_id, '/soft/EasyAccess/EasyAccess20_setup.exe', $tmp_bufer . $attrs[ 'put' ] . '/' . $attrs[ 'fname' ], FTP_BINARY );
            ...
            ftp_put( $conn_id, '/soft/EasyAccess/version.txt', $tmp_bufer . $attrs[ 'put' ] . '/version.txt', FTP_BINARY );
            //break;
          }
