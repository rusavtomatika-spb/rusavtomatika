...

{
    ...
    if (!$db) {
        ...
        if ($_SERVER['DOCUMENT_ROOT'] == '/home/weblec/public_html/rusavtomatika.com') {
            ...
            $user = "weblec_den";      // Имя пользователя

            $pass = '646111';  // Пароль

            $dbnm = "weblec_weintek";      // Имя БД
            ...
            $port = "";      // Номер порта, 3306 - по умолчанию

            $user = "olgaglr_rusavto";      // Имя пользователя

            $pass = 'pGrk5V2S';  // Пароль

            $dbnm = "olgaglr_rusavto";      // Имя БД

        } else {

//        $user = "weblec_olga";      // Имя пользователя

//        $pass = 'olgaglr';  // Пароль

//        $dbnm = "weblec_olga-ra";      // Имя БД



            $user = "valovenko_rusavt";      // Имя пользователя

            $pass = 'wyZM836401WL7x99';  // Пароль

            $dbnm = "valovenko_rusavt";      // Имя БД
