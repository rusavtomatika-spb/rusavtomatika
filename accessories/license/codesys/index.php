...
$KEYWORDS = '';
$TITLE = 'CODESYS программный комплекс для панелей Weintek (карта активации/лицензия)';
$SERVER_PROTOCOL = $_SERVER['SERVER_PROTOCOL'] == "HTTP/1.1" ? "http://" : "https://";

global $extra_openGraph;
$extra_openGraph = Array(
    "openGraph_image" => "//www.rusavtomatika.com/upload_files/images/codesysguide/codesys1.png",
    "openGraph_title" => "CODESYS программный комплекс для панелей Weintek (карта активации/лицензия)",
...
<article class="xxx">
    <div class="blockofcols_container">
        <?=$nav?>
        <h1>CODESYS программный комплекс для панелей Weintek (приобретение карты активации/лицензии)</h1>
                ...
                <div id="tabs-1">
                    ...
                    $component->show(array(
                        ...
                        "template_arguments" => array(
                            ...
                            "order" => "diagonal",
                            "series" => "cMT",
                            "custom_sql_query" => "and (`codesys` like '1')"
                        )
                    );
                    ?>
                </div>
