<h2>Сохранение документов на наш сервер: <? echo (date("H:i:s")); ?></h2>
<?
...
$all_external_docs = $_SERVER[ 'DOCUMENT_ROOT' ] . "/documents__/docs_result.txt";
...
echo $ifs;
$time_save_secs = round( ( ( microtime( true ) - $start_save ) / 60 ), 2 );
echo "<br>Сохранение документов заняло " . $time_save_secs . " мин<br>";
echo $ifs . " документов сохранено</br><hr>";
require '03_docs2ftp.php';
?>
